...
func Test_leastInterval(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: 12, // D -> A -> B -> C -> A -> B -> C -> A -> B -> C -> D -> E
		},
		{
			args: args{
				tasks: []byte{'A', 'A', 'A', 'A', 'B', 'B', 'B', 'B', 'C', 'C', 'C', 'C', 'D', 'D', 'D', 'D', 'E', 'F'},
				n:     4,
			},
			want: 19,
		},
